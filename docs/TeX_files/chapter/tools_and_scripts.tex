...
\section{mmorpdnd.py \label{mmorpdnd.py}}
...
\subsection{stockpile-cron.sh \label{stockpile-cron.sh}}
...
\section{templates/visualize\_nodes.py}
...
\section{templates/trash/img/cleanup\_trash\_images.py}
